	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/role/findAllPermission.do">权限资源管理</a></li>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">权限资源名称</th>
									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllPermission.do?id=${permission.id}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
